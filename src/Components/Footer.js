...
const Footer = () => {
  ...
  return (
    <div className={`fixed bottom-0 left-0 w-full bg-primary-dark/90 backdrop-blur-md border-t border-white/10 transition-all duration-300 z-50 ${isFooterExpanded ? 'h-64' : 'h-12'}`}>
      <div className="flex items-center justify-center h-12 cursor-pointer hover:bg-white/5 transition-colors" onClick={toggleFooter}>
